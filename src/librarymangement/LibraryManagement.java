...
public class LibraryManagement {
    ...
    private static void user_menu(String UID) {
...
login_but.addActionListener((ActionEvent e) -> {
...
view_but.addActionListener((ActionEvent e) -> {
...
my_book.addActionListener((ActionEvent e) -> {
...
create_but.addActionListener((ActionEvent e) -> {
...
users_but.addActionListener((ActionEvent e) -> {
...
issued_but.addActionListener((ActionEvent e) -> {
    JFrame f1 = new JFrame("Users List");
//f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
Connection connection = connect();
...
add_user.addActionListener((ActionEvent e) -> {
    ...
    create_but1.addActionListener((ActionEvent e1) -> {
        //set text field for password
        JPasswordField F_pass1 = new JPasswordField();
        F_pass1.setBounds(110, 50, 200, 30);
        //set radio button for admin
        JRadioButton a3 = new JRadioButton("Admin");
        a3.setBounds(55, 80, 200, 30);
        //set radio button for user
        JRadioButton a4 = new JRadioButton("User");
        a4.setBounds(130, 80, 200, 30);
        //add radio buttons
        ButtonGroup bg1 = new ButtonGroup();
        bg1.add(a3);
        bg1.add(a4);
        JButton create_but2 = new JButton("Create"); //creating instance of JButton for Create
        create_but2.setBounds(130, 130, 80, 25); //x axis, y axis, width, height
        create_but2.addActionListener((ActionEvent e2) -> {
            String username = F_user.getText();
            String password = F_pass1.getText();
            Boolean admin = false;
            if (a3.isSelected()) {
                admin=true;
            }
...
add_book.addActionListener((ActionEvent e) -> {
    ...
    JButton create_but1 = new JButton("Submit"); //creating instance of JButton to submit details
    create_but1.setBounds(130, 130, 80, 25); //x axis, y axis, width, height
    create_but1.addActionListener((ActionEvent e1) -> {
...
issue_book.addActionListener((ActionEvent e) -> {
    //enter details
    ...
    JButton create_but1 = new JButton("Submit"); //creating instance of JButton
...
return_book.addActionListener(new ActionListener() {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        create_but1.setBounds(130, 170, 80, 25); //x axis, y axis, width, height
        create_but1.addActionListener(new ActionListener() {
            @Override
